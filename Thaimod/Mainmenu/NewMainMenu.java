...
public class NewMainMenu extends GuiScreen
{
    ...
    static Minecraft func_110348_a(NewMainMenu par0GuiMainMenu)
    {
        return par0GuiMainMenu.mc;
    }

    static void func_130021_b(NewMainMenu par0GuiMainMenu)
    {
    }
    ...
    static Minecraft func_130018_c(NewMainMenu par0GuiMainMenu)
    {
        return par0GuiMainMenu.mc;
    }

    static Minecraft func_130019_d(NewMainMenu par0GuiMainMenu)
    {
        return par0GuiMainMenu.mc;
    }
}
